...
`;
    ...
    // updated the expected result because the solver returns the first valid occurrence found in the grid based on the search order
    // (there is more than one valid occurrence for some words in the grid)
    expect(result).toBe(
